...
| `.github/workflows/*` | `.github/workflows/ci.yml`, `.github/workflows/publish.yml` | CI/CD -> Rust CI/publish workflows, immutable sibling revisions, fail-closed sibling source-identity verification, example parity, and trusted default-branch badge publication |
